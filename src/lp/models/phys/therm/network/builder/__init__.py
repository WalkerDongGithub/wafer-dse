...
本包惯例（与 physical/thermal/_solver 一致）：ABC 写在 __init__，
每个子类一个文件。
...
if TYPE_CHECKING:
    from lp.models.phys.therm.network._mfit_system import MfitStackConfig
...
from lp.models.phys.therm.network.builder._analytic import (  # noqa: E402
