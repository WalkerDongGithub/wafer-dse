...
- [ ] EvalDesigner 复核 §4.2.2 末尾"布线/面积绑定"与 §5.3 叙述的一致性；round 21+ 指令【2】"展现耦合影响"实验轴（散热增强释放带宽 / 降性能缓解布线饱和）落 §5 后回填本稿引用
